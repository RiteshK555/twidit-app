  ...
  return <>
    ...
    <Button  onClick={(e) => {
      signOut();
        ...
        { 
            AllPosts.map((post) => <Post boolButton={false} id={post.id} handleAsyncLikePost={handleAsyncLikePost} likes={post.likes} postsData={post.data} handleDelete={handleDeletePost}/>)
        }
    </>
    }
  </>
