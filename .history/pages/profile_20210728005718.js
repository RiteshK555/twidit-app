...
const Profile = ({session,serverBio,serverPosts}) => {
    ...
    if(session===null or session===undefined)
    {
    ...
    return (
        ...
        <div style={{display:'flex',justifyContent: 'center', paddingTop:22,paddingLeft:61}}>
            <Form onSubmit={handleTwidit}>
              <Form.Group className="mb-3">
                <Form.Control placeholder="Max length is 300 characters." as="textarea" value={fakeTwidit} onChange={twiditChange} rows={3} cols={50}/>
                </Form.Group>
