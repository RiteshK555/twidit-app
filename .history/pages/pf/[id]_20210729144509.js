...
const Profile = ({serverPosts,session,serverBio}) => {
    ...
    return (
        ...
        { 
            posts.map((post) => <Post boolButton={session} id={post.id} handleAsyncLikePost={handleAsyncLikePost} likes={post.likes} postsData={post.data} handleDelete={handleDeletePost}/>)
        }
        </>
