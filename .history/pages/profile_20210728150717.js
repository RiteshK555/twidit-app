               ...
               .then((querySnapshot) => {
                ...
                .then((querySnapshot) =>{
                    querySnapshot.forEach((doc)=>{
                        ...
                        serverPosts.push(JSON.stringify(doc.data()
                        // console.log(doc);
                        // serverPosts.push(doc);
                        // console.log(doc);
                        // querySnapshot.forEach((doc)=>{
                        //         serverPosts.push(doc.data().data);
                        //         console.log(doc);
                        // })
                ...
                // if(doc.collection("posts")===undefined || doc.collection("posts")===null || doc.collection("posts")===[]){
