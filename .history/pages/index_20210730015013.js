  ...
  return <>
    ...
    <Button  onClick={(e) => {
      signOut();
        ...
        { 
            AllPosts.map((post) => <Post boolButton={true} id={post.id} handleAsyncLikePost={handleAsyncLikePost} likes={post.likes} postsData={post.data} handleDelete={handleDeletePost}/>)
        }
    </>
    }
  </>
