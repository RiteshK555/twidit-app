...
const Post = ({likes,postsData,handleDelete,id,handleAsyncLikePost,delete}) => {
                    ...
                    <tr>
                        <td style={{paddingTop:1}}>
                            ...
                            {like==="primary"?likes:likes+1}
                             { delete===true &&  <Button value={id} onClick={handleDelete} style={{marginLeft:500,marginBottom:12}} size="sm" variant="danger">delete</Button>
                                }
                        </td>
                    </tr>
                    </tbody>
