...
//     });
// }
const Post = ({likes,postsData,handleDelete,id}) => {
                ...
                <table>
                    ...
                    <tr>
                        <td style={{paddingTop:1}}>
                            <newThumbUpIcon/>newThumbUpIcon>
                            <ThumbUpIcon value={id} color={like} onClick={handleLikePost} style={{marginLeft:20,marginBottom:8,paddingBottom:0,cursor:"pointer"}} />
